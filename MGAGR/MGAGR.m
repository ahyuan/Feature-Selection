...
% Reference:
%   "Robust Unsupervised Feature Selection via Multi-Group Adaptive Graph
%   Representation", Mengbo You, Aihong Yuan, Min Zou, Dongjian He, and
%   Xuelong Li, IEEE Transactions on Knowledge and Data Engineering, 2023.
%
% input:
